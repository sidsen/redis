...
//#define _TM_USELARGEPAGES              // if defined, allocate large pages to improve TLB usage. Requires account with SeLockMemoryPrivilege
#define _TM_NUMAALLOC                  // if defined, allocates memory local to NUMA node. Before allocating, a thread must call
                                       //   _tmreportprocessor to indicate on which processor it is running
//#define _TM_NUMA_WARNING_NOREPORTPROCESSOR // if defined, issue a warning when malloc is called before _tmreportprocessor
...
#define _TM_PAGESIZE              4096 // size of page
